...
class JianpuChord: #Singular notes are also represented as chords with a single note
    ...
    def getUnderline(chord_duration):
        if chord_duration == 0.25 or chord_duration == 0.375:
            return 2
        elif chord_duration == 0.5 or chord_duration == 0.75:
            return 1
        elif chord_duration == 0.125 or chord_duration == 0.1875:
            return 3
        elif chord_duration == 0.0675 or chord_duration == 0.09375:
            return 4
        elif chord_duration == 0.03375 or chord_duration == 0.046875:
            return 5
        else: 
            return 0
